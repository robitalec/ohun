...
#' @return A spectrogram along with lines highlighting the position of sound events in 'reference' and/or 'detection'. If supplied it will also plot the amplitude envelope or correlation scores below the spectroram.
#' @export
#' @name label_spectro
